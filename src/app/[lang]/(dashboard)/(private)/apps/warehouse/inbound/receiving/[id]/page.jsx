...
// Server Actions
import { getGoodsReceivingById, updateGoodsReceiving } from '@/server/actions/getGoodsReceivingData'

const EditGoodsReceivingPage = () => {
  ...
  useEffect(() => {
    const loadReceivingOrder = async () => {
      try {
        setInitialLoading(true)
        const order = await getGoodsReceivingById(id)
        setFormData({
        ...
        setError('Failed to load receiving order')
      } finally {
          ...
          <CardHeader
            title={
              <Box className='flex items-center gap-2'>
                ...
                <Box>
                  <Typography variant='h5'>Edit Goods Receiving Order</Typography>
            ...
            subheader='Update receiving order details'
          />
          <Divider />
            ...
            <CardContent>
              <Box className='flex items-center justify-between'>
                ...
                <Box className='flex gap-4'>
                  ...
                  >
                    {loading ? 'Updating...' : 'Update Receiving Order'}
                  </Button>
                </Box>
              </Box>
            </CardContent>
...
export default EditGoodsReceivingPage
