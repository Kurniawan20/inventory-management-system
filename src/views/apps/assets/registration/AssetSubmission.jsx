      ...
      <CardContent>
        {submitResult ? (
          ...
          <Grid container spacing={4}>
            <Grid item xs={12}>
              <Paper sx={{ p: 3 }}>
                <Typography variant="h6" sx={{ mb: 3 }}>Asset Summary</Typography>
                
                <Grid container spacing={3}>
                  <Grid item xs={12} md={6}>
                    <List dense>
                      {assetSummary.slice(0, Math.ceil(assetSummary.length / 2)).map((item, index) => (
                        <ListItem key={index}>
                  ...
                  <Grid item xs={12} md={6}>
                    <List dense>
                      {assetSummary.slice(Math.ceil(assetSummary.length / 2)).map((item, index) => (
                        <ListItem key={index}>
                          <ListItemIcon sx={{ minWidth: 30 }}>
                            <i className="ri-checkbox-circle-line" style={{ color: 'var(--mui-palette-primary-main)' }} />
                          </ListItemIcon>
